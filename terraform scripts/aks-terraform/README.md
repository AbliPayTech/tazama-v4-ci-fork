## Terraform Setup for an Azure Cluster.

The terraform files under `aks-terraform/` folder and automate the creation of the AKS cluster needed to run helm commands under the helm section..

The `aks-terraform` folder contains the following files;
...
|`main.tf`                      | Defines modules and resources for the infrastructure to be created in Azure Cloud.             |
